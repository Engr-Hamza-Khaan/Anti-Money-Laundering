...
LINES_UR = [
    ...
    ("03-onboard-brief-elena-1.mp3", "elena",
     "کاؤنٹر پر ایک نیا رشتہ انتظار کر رہا ہے۔ آپ کا کام کسٹمر ڈیو ڈیلیجنس ہے: ان کی شناخت کریں، شناخت کا کسی قابلِ اعتماد ذریعے سے ویریفائی کریں، یہ طے کریں کہ کاروبار کا اصل مالک کون ہے، اور پھر فیصلہ کریں کہ اس فائل پر کتنی جانچ چاہیے۔"),
    ("04-onboard-brief-elena-2.mp3", "elena",
